...
def main():
    ...
    plt.figure(figsize=(10, 5))
    sns.barplot(x=weekly_activity.index, y=weekly_activity.values, palette='viridis', hue=weekly_activity.index, dodge=False, legend=False)
    ...
    plt.figure(figsize=(10, 5))
    sns.barplot(x=busy_users.index, y=busy_users.values, palette='viridis', hue=busy_users.index, dodge=False, legend=False)
